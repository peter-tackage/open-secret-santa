...
import com.moac.android.opensecretsanta.ui.edit.EditActivity;
import com.moac.android.opensecretsanta.ui.restrictions.RestrictionsActivity;
import com.moac.android.opensecretsanta.ui.settings.AllPreferencesActivity;
import com.moac.android.opensecretsanta.util.GroupUtils;
import com.moac.android.opensecretsanta.util.Longs;
...
public class MainActivity extends AppCompatActivity implements
                                                    MemberListFragment.FragmentContainer,
                                                    NotifyDialogFragment.FragmentContainer,
                                                    MemberEditor,
                                                    ComponentHolder<MainActivityComponent> {
    ...
    public void onCreate(Bundle _savedInstanceState) {
        ...
        // Find or create existing worker fragment
        mNotifyExecutorFragment = (NotifyExecutorFragment) fm
                .findFragmentByTag(NOTIFY_EXECUTOR_FRAGMENT_TAG);

        if (mNotifyExecutorFragment == null) {
            mNotifyExecutorFragment = NotifyExecutorFragment.create();
            fm.beginTransaction().add(mNotifyExecutorFragment, NOTIFY_EXECUTOR_FRAGMENT_TAG)
              .commit();
        }
        initialiseUI();
    }
    ...
    private void initialiseUI() {
        ...
        View headerView = getLayoutInflater()
                .inflate(R.layout.drawer_section_header_view, mDrawerList, false);
        ...
        if (groupId > PersistableObject.UNSET_ID) {
            ...
            if (adapterPosition >= 0) {
                ...
                mSharedPreferences.
                                          edit()
                                  .remove(OpenSecretSantaApplication.MOST_RECENT_GROUP_KEY).apply();
    ...
    private void requestNotifyDraw(Group group, long[] memberIds, boolean isAllMembers) {
        ...
        if (NotifyUtils.requiresDefaultSmsCheck() && NotifyUtils
                .requiresSmsPermission(this, mDb, memberIds)) {
            // If using SMS - display warning about the SMS permissions
            boolean showSmsWarningDialog = mSharedPreferences
                    .getBoolean(SHOW_SMS_WARNING_DIALOG_SETTING_KEY, true);
    ...
    @Override
    public void executeNotifyDraw(NotifyAuthorization auth, final Group group,
                                  final long[] members) {
    ...
    private void populateDrawerListView(DrawerListAdapter drawerListAdapter) {
        ...
        drawerListItems.add(new DrawerButtonItem(addIcon, getString(R.string.add_group),
    ...
    private long createNewGroup() {
        ...
        GroupDetailsRow item = new GroupDetailsRow(group.getId(), group.getName(),
                                                   group.getCreatedAt());
    ...
    private void slideInIntent(Intent intent) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN) {
            ...
            Bundle translateBundle = ActivityOptions
                    .makeCustomAnimation(this, R.anim.slide_in_left, R.anim.slide_out_left)
                    .toBundle();
    ...
    private void showGroup(long groupId, boolean forceUpdate) {
        ...
        if (groupId == mCurrentGroupId && !forceUpdate) {
            return;
        }
        ...
        MemberListFragment existing = (MemberListFragment) fragmentManager
                .findFragmentByTag(MEMBERS_LIST_FRAGMENT_TAG);
        ...
        mSharedPreferences.
                                  edit()
                          .putLong(OpenSecretSantaApplication.MOST_RECENT_GROUP_KEY, groupId)
                          .apply();
    }
    ...
    private void showSmsWarningDialog(final Group group, final long[] memberIds,
        ...
        View dialogContentView = getLayoutInflater()
                .inflate(R.layout.layout_dialog_sms_warning, null);
        final CheckBox dontShowAgainCheckBox = (CheckBox) dialogContentView
                .findViewById(R.id.checkBox_dontShowAgain);
        ...
        new AlertDialog.Builder(MainActivity.this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        mSharedPreferences.edit().putBoolean(SHOW_SMS_WARNING_DIALOG_SETTING_KEY,
